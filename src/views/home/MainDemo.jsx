...
import TitleSection2 from "../../components/heading/TitleSection2";
...
const MainDemo = () => {
  return (
    <React.Fragment>
      <Helmet>
        <title>Transit Security Solutions</title>
      </Helmet>
      ...
      <Container as={TitleSection2} description="Our Services ">
        Our Services
      </Container>
      ...
      {/*Start Blog*/}
      <Container className="section-margin dsn-right-container">
        <TitleSection description="">Solutions</TitleSection>
