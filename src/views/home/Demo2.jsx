...
import PortfolioSwiper from "../../components/OurServices/PortfolioSwiper";
...
function Demo2(props) {
  return (
    <>
      <Helmet>
        <title>Transit - Portfolio & Agency React Template </title>
      </Helmet>
      <HeaderNormal
      ...
      <div className="p-relative section-margin v-dark-head text-center">
        ...
        <FadeUpTrigger tag={Container} className="v-middle z-index-1">
          ...
          <p className="m-w570 mt-20 dsn-auto">
            When the Escalators Died in Stockholm’s Subway, Reebok Was There to
            Give People a Lift.Literally
          </p>
          <ButtonPopup
            className="mt-20"
      ...
      >
        ...
        <FadeUpTrigger tag={DsnGrid} col={1} rowGap={30} rowGapTablet={20}>
          <h2 className="title-section border-line-left">Time Tag Watch.</h2>
          <h6>
